...
from pr2_pbd_app.ArmStepMarkerSequence import ArmStepMarkerSequence
from pr2_pbd_app.Exceptions import ConditionError, StoppedByUserError
from pr2_pbd_app.World import World
from pr2_pbd_app.condition_types.IKCondition import IKCondition
from pr2_pbd_app.condition_types.SpecificObjectCondition import SpecificObjectCondition
from pr2_pbd_app.msg import ArmState, ExecutionStatus, ArmMode, Strategy, StepExecutionStatus
from pr2_pbd_app.step_types.Step import Step


def manipulation_step_constructor(loader, node):
    from pr2_pbd_app.Robot import Robot
...
class ManipulationStep(Step):
    ...
    """
    action_directory = rospy.get_param('/pr2_pbd_app/actionsRoot', '/home/sonyaa/pbd_manipulation_saved/')
    file_extension = rospy.get_param('/pr2_pbd_app/fileExtension', '.yaml')

    def __init__(self, *args, **kwargs):
        from pr2_pbd_app.Session import Session
        from pr2_pbd_app.Robot import Robot
