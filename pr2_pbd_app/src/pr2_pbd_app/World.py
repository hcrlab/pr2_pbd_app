...
# Local stuff
from pr2_pbd_app.msg import Object, ArmState
from pr2_pbd_app import Response
...
class World:
    ...
    objects = []
    world = None
    segmentation_service = rospy.get_param("/pr2_pbd_app/tabletop_segmentation_service")
