...
class Logger:
    ...
    def initializeBags(self):
        self.speechRecBag = rosbag.Bag(self.logDirectory + 'humanSpeech.bag', 'w')
        self.ttsBag = rosbag.Bag(self.logDirectory + 'robotSpeech.bag', 'w')
        self.gazeCommandBag = rosbag.Bag(self.logDirectory + 'gazeCommand.bag', 'w')
        self.gazeTargetBag = rosbag.Bag(self.logDirectory + 'gazeTarget.bag', 'w')
        self.jointStateBag = rosbag.Bag(self.logDirectory + 'jointState.bag', 'w')
